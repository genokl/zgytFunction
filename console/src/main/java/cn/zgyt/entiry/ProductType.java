...
public class ProductType implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2592430167395293189L;
...
//    private List<Product> products;          //1，公司概况  2,联系我们 3，公司要闻，//卤货单品， 套餐
	...
	@ApiModelProperty(value = "类型前台链接")
    private String portalUrl;    		  	   //排序
	
	private String useType;    		  	   //创建文章时选择用
